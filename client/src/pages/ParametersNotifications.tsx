...
import { useNotifications, useUpdateParameter, useResetParameters } from "@/hooks/use-parameters";
...
export default function Parameters() {
  const { data: parameters, isLoading } = useNotifications();
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <Header title="Parameters Notifications" />
